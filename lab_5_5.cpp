...
int main () {
  ...
  cin >> choice1;
  switch(choice1) { //มันerrorอะไรอ่ะอาจารย์
    case "S" : score += 100; cout << "You say sorry to the teacher. Now you can playing basketball." << endl; break;
    case "N" : score -= 20;  life -= 1; cout << "You do not care about your own actions. Make you be blamed." << endl; break;
  }
